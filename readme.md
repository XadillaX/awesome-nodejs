...
- ODM / ORM
	...
	- [Toshihiko](https://github.com/xadillax/toshihiko) - A simple MySQL ORM with optional cache layer in Huaban, Dasouche and Sohu with :heart:. For performance, this ORM does not provide operations like in, group by, join and so on.
- Query builder
